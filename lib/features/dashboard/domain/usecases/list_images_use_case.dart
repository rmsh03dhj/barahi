...
abstract class ListImagesUseCase implements BaseUseCase<List<ImageDetails>, bool> {}

class ListImagesUseCaseImpl implements ListImagesUseCase {
  final dashboardRepo = sl<DashboardRepository>();

  @override
  Future<Either<Failure, List<ImageDetails>>> execute(bool showSharedImages) async {
    try {
