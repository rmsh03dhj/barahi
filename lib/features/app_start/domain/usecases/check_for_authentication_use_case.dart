...
abstract class CheckForAuthenticationUseCase
    implements BaseUseCase<User, NoParams> {}

class CheckForAuthenticationUseCaseImpl
    implements CheckForAuthenticationUseCase {
